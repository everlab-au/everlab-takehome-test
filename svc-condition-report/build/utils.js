...
exports.parseObservationResult = exports.formatDate = exports.calculateAge = void 0;
// datestring is of format YYYYMMDD
function calculateAge(birthDate) {
    // Convert birthDate string to Date object
    const birthDateObj = new Date(parseInt(birthDate.substring(0, 4)), // Year
    ...
    if (currentDate <
        new Date(currentDate.getFullYear(), birthDateObj.getMonth(), birthDateObj.getDate())) {
        age--;
    }
    return age;
}
...
function formatDate(dateString) {
    ...
    const formattedDate = `${day}${daySuffix(day)} ${months[monthIndex]} ${year}, ${hour.toString().padStart(2, '0')}:${minute
        .toString()
        .padStart(2, '0')}`;
    return formattedDate;
}
exports.formatDate = formatDate;
function parseObservationResult(value) {
    if (!value) {
        return null;
    }
...
exports.parseObservationResult = parseObservationResult;
